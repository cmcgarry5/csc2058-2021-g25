...
/**
 * Class to return multiple variables from a method
 * @author ross
 *
 */

class ListPlayersPlayer { 
...
public class BackFromTheBrinkGame {
	...
	public static void main(String[] args) {
		...
		// Validate number of players between 2 and 8 inclusive
		do {
			try {
